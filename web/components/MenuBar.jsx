  ...
  },
  {
    ...
    items: [
      ...
      { separator: true },
      {
        ...
        disabled: true,
        submenu: [
          { label: 'Toggle Bookmark', disabled: true },
          { label: 'Next Bookmark', disabled: true },
          { label: 'Previous Bookmark', disabled: true },
          { label: 'Clear All Bookmarks', disabled: true },
          { label: 'Cut Bookmarked Lines', disabled: true },
          { label: 'Copy Bookmarked Lines', disabled: true },
          { label: 'Paste to (Replace) Bookmarked Lines', disabled: true },
          { label: 'Remove Bookmarked Lines', disabled: true },
          { label: 'Remove Non-Bookmarked Lines', disabled: true },
          { label: 'Inverse Bookmarks', disabled: true },
        ],
      },
      { separator: true },
