  ...
  },
  {
    ...
    items: [
      ...
      { separator: true },
      {
        ...
        submenu: [
          { label: 'Copy Current File Name to Clipboard', action: 'copy-filename' },
          { label: 'Copy Current File Path to Clipboard', action: 'copy-filepath' },
          { label: 'Copy Current File Directory to Clipboard', action: 'copy-filedir' },
        ],
      },
      ...
      { separator: true },
      {
        ...
        submenu: [
          { label: 'Convert to Windows Format (CR LF)', action: 'eol-crlf' },
          { label: 'Convert to Unix Format (LF)', action: 'eol-lf' },
          { label: 'Convert to Old Mac Format (CR)', action: 'eol-cr' },
        ],
      },
      {
        ...
        submenu: [
          ...
          { label: 'Remove Unnecessary Blank and EOL', action: 'remove-blank-eol' },
          { label: 'Remove Unnecessary Blank', action: 'remove-blank' },
        ],
      },
      { label: 'Paste Special' },
      {
        ...
        submenu: [
          ...
          { label: 'Delete Current Line', action: 'line-delete' },
          { separator: true },
