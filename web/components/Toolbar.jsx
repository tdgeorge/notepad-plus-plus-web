  ...
  return (
    <div className={styles.toolbarWrapper}>
      ...
      <div className={styles.toolbar} ref={scrollRef} role="toolbar" aria-label="Main toolbar">
        <ToolbarButton title="New (Ctrl+N)" onClick={onNew} tone="green">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
            <path d="M9 1H3a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6L9 1zm0 1.5L12.5 6H9V2.5zM3 14V2h5v5h5v7H3z" />
          </svg>
        </ToolbarButton>

        <ToolbarButton title="Open (Ctrl+O)" onClick={onOpen} tone="green">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
            <path d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v7a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 1 12.5v-9z" />
          </svg>
        </ToolbarButton>

        <ToolbarButton title="Save (Ctrl+S)" onClick={onSave} tone="teal">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Save All (Ctrl+Shift+S)" onClick={onSaveAll} tone="teal">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Close (Ctrl+W)" onClick={onClose} tone="red">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
            <path d="M9 1H3a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6L9 1zm0 1.5L12.5 6H9V2.5zM3 14V2h5v5h5v7H3z" />
        ...
        <ToolbarButton title="Close All" onClick={onCloseAll} tone="red">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Print (Ctrl+P)" onClick={onPrint} tone="steel">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Cut (Ctrl+X)" onClick={onCut} tone="brown">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Copy (Ctrl+C)" onClick={onCopy} tone="blue">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Paste (Ctrl+V)" onClick={onPaste} tone="amber">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Undo (Ctrl+Z)" onClick={onUndo} tone="blue">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Redo (Ctrl+Y)" onClick={onRedo} tone="blue">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Find (Ctrl+F)" onClick={onFind} tone="orange">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.099zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
          </svg>
        </ToolbarButton>

        <ToolbarButton title="Replace (Ctrl+H)" onClick={onReplace} tone="orange">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.099zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
        ...
        <ToolbarButton title="Zoom In (Ctrl+Numpad+)" onClick={onZoomIn} tone="blue">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
        ...
        <ToolbarButton title="Zoom Out (Ctrl+Numpad-)" onClick={onZoomOut} tone="blue">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
